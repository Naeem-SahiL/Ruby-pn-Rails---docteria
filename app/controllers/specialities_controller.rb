class SpecialitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @speciality.save
        format.html { redirect_to specialities_url, notice: 'Speciality was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @speciality.update(speciality_params)
        format.html { redirect_to specialities_url, notice: 'Speciality was successfully updated.' }
  ...
  def speciality_params
    params.require(:speciality).permit(:spaciality)
  end
end
